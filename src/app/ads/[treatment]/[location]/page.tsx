...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...meta,
    // Paid campaigns default to campaign.indexing_policy (usually noindex,follow).
    ...
    <CampaignAdsShell>
      <div className="mx-auto max-w-lg px-4 py-20 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          <Link
            href="https://novalyte.io/patients"
          ...
          <Link
            href="https://novalyte.io/directory"
...
export default async function AdsTreatmentLocationPage({ params, searchParams }: PageProps) {
  ...
  // Optional ?campaign= alias is accepted for attribution overlays; page still resolves by path.
  void query.campaign;
