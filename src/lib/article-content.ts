...
const trtBlocks: ArticleBlock[] = [
  ...
  { type: "callout", tone: "tip", text: "Tip: Bring your lab results, a list of current medications, and a symptom diary to every visit. Tracking energy, mood, sleep, and exercise across several weeks gives your provider meaningful signal beyond a single point-in-time lab. If you want help organizing questions before that visit, take a [short informational TRT assessment](/?view=assessment&params=%7B%22slug%22%3A%22testosterone-replacement-therapy%22%7D) — it is educational, not a diagnosis. Men comparing hormone care with broader longevity claims may also find [longevity medicine: science vs. hype](/journal/longevity-medicine-science-vs-hype) useful." },
...
const glp1Blocks: ArticleBlock[] = [
  ...
  { type: "paragraph", text: "Distinguishing between these regulatory approvals matters. A medication approved for type 2 diabetes is not automatically appropriate for weight management in someone without diabetes, and the specific indication, dose, and supervision differ. Generic categories — 'weight loss injections' — conceal clinically meaningful differences between medications. Men also comparing hormone-related options may want our [TRT overview for men](/journal/understanding-trt-overview)." },
  ...
  { type: "paragraph", text: "GLP-1 medications have meaningfully expanded the toolkit for chronic weight management in eligible patients. They are not, however, a substitute for sustained behavioral change, ongoing monitoring, or addressing the root lifestyle and metabolic drivers of weight. The strongest outcomes tend to come from coordinated care: a prescribing clinician, structured lifestyle support, and a clear plan for what happens after the medication ends. If you are exploring whether a medically supervised weight-loss conversation makes sense, a [short informational weight-loss assessment](/?view=assessment&params=%7B%22slug%22%3A%22medical-weight-loss%22%7D) can help you organize questions — it is not a diagnosis. For a related read on broader claims about healthspan, see [longevity medicine: science vs. hype](/journal/longevity-medicine-science-vs-hype)." },
];
...
const recruitingBlocks: ArticleBlock[] = [
  ...
  { type: "paragraph", text: "The mismatch is structural: the men's health candidate pool is small relative to demand, the work spans clinical and operational roles, and the regulatory complexity (especially telehealth) means the wrong hire creates real compliance exposure, not just operational drag. Clinics wrestling with that operational backdrop may also find [the state of men's health clinic operations](/journal/state-of-mens-health-clinic-operations) useful." },
...
const healthcareTechnologyAccessBlocks: ArticleBlock[] = [
  ...
  { type: "paragraph", text: "A telehealth visit eliminates the commute, the waiting room, and in some cases the discomfort of discussing sensitive health topics in person. Digital platforms allow patients to complete intake forms in advance, receive appointment reminders, communicate through secure messaging, and access test results through patient portals. For men researching testosterone evaluation, erectile-dysfunction care, medical weight management, or preventive screening, these tools can make the difference between taking action and continuing to wait. Start with our educational guides on [testosterone replacement therapy](/journal/understanding-trt-overview) and [GLP-1 medications and medical weight loss](/journal/glp-1-medical-weight-loss), or take a [short informational assessment](/patients) if you want help organizing questions before you talk to a clinician." },
